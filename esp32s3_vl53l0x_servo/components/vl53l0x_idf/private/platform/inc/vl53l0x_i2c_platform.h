 ...
 *
 * @return uint32_t monotonic tick count in milliseconds
 */
...
int32_t VL53L0X_write_byte(i2c_master_dev_handle_t dev_handle,
                           uint8_t index,
                           uint8_t data);
...
int32_t VL53L0X_write_word(i2c_master_dev_handle_t dev_handle,
                           uint8_t index,
                           uint16_t data);
...
int32_t VL53L0X_read_byte(i2c_master_dev_handle_t dev_handle,
                          uint8_t index,
                          uint8_t *pdata);
...
int32_t VL53L0X_read_word(i2c_master_dev_handle_t dev_handle,
                          uint8_t index,
                          uint16_t *pdata);
...
int32_t VL53L0X_read_dword(i2c_master_dev_handle_t dev_handle,
                           uint8_t index,
                           uint32_t *pdata);
